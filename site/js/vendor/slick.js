...
(function(factory) {
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.options.arrows === true && _.slideCount > _.options.slidesToShow) {
            ...
            var dotsElement = document.getElementById("slickDots");

            _.$prevArrow = $(
                '<button type="button" class="slick-prev" tabIndex="-1">Previous</button>').prependTo(dotsElement
                );
            _.$nextArrow = $(
                '<button type="button" class="slick-next" tabIndex="-1">Next</button>').appendTo(dotsElement
                );
    ...
    Slick.prototype.buildDots = function() {
        ...
        if (_.options.dots === true && _.slideCount > _.options.slidesToShow) {
            ...
            dotString = '<ul class="slick-dots" id="slickDots">';
    ...
    Slick.prototype.changeSlide = function(event) {
        ...
        switch (event.data.message) {
            ...
            case 'index':
                _.slideHandler(($(event.target).parent().index() - 1) * _.options.slidesToScroll);
                break;
